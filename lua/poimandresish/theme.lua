local blend = require('poimandresish.utils').blend
...
function M.get(config)
  ...
  theme = {
    ...
    Cursor = { fg = p.background3, bg = p.fg, style = 'NONE' },
    CursorColumn = { bg = p.blueGray4, style = 'NONE' },
    CursorIM = { fg = p.background3, bg = p.yellow, style = 'NONE' },
    CursorLine = { bg = p.blueGray4, style = 'NONE' },
    CursorLineNr = { fg = p.text, style = 'NONE' },
    ...
    FloatBorder = { fg = (config.disable_background and p.blueGray3) or p.background1 },
    ...
    PmenuSel = { fg = p.text, bg = p.blueGray4 },
    ...
    StatusLine = { fg = p.blue3, bg = p.none },
    StatusLineNC = { fg = p.blue3, bg = p.none },
    StatusLineTerm = { link = 'StatusLine' },
    StatusLineTermNC = { link = 'StatusLineNC' },
    TabLine = { fg = p.blue3, bg = p.none },
    TabLineFill = { bg = p.none },
    TabLineSel = { fg = p.text, bg = p.none },
    Title = { fg = p.text },
    ...
    Comment = { fg = p.blueGray2 }, -- (preferred) any special symbol
    ...
    -- mkdHeading = { bg = p.none, style = "bold" },
    -- mkdCode = { bg = p.none, fg = p.text },
    ...
    SnacksPicker = { fg = p.text, bg = p.none },
    SnacksPickerNormalFloat = { fg = p.text, bg = p.none },
    SnacksPickerTitle = { fg = p.text, bg = p.none },
    SnacksPickerBorder = { fg = p.background1, bg = p.none },
    SnacksPickerNormal = { fg = p.text, bg = p.none },
    SnacksPickerMatch = { fg = p.text, bg = p.none },
    SnacksPickerCursor = { fg = p.text, bg = p.blueGray4 },
    SnacksPickerPrompt = { fg = p.text, bg = p.none },
    SnacksPickerDim = { fg = p.blueGray2, bg = p.none },
    SnacksInputIcon = { fg = p.text, bg = p.none },
    SnacksIndent = { fg = p.background1, nocombine = true },
    SnacksIndentChunk = { fg = p.yellow, nocombine = true },
    SnacksIndentScope = { fg = p.yellow, nocombine = true },
    SnacksPickerInputBorder = {
      fg = p.background1,
      bg = p.none,
    },
    SnacksPickerInputTitle = { fg = p.text, bg = p.none },
    SnacksPickerBoxTitle = { fg = p.text, bg = p.none },
    SnacksPickerSelected = { fg = p.text, bg = p.blueGray3 },
    ...
    BufferLineBackground = { fg = p.none, bg = p.none },
    BufferLineBuffer = { fg = p.none, bg = p.none },
    BufferLineBufferSelected = { bg = p.none },
    BufferLineBufferVisible = { bg = p.none },
    BufferLineCloseButton = { bg = p.none },
    BufferLineCloseButtonSelected = { bg = p.none },
    BufferLineCloseButtonVisible = { bg = p.none },
    BufferLineDuplicate = { bg = p.none },
    BufferLineDuplicateSelected = { bg = p.none },
    BufferLineDuplicateVisible = { bg = p.none },
    BufferLineError = { bg = p.none, sp = p.none },
    BufferLineErrorDiagnostic = { bg = p.none, sp = p.none },
    BufferLineErrorDiagnosticSelected = { bg = p.none, sp = p.none },
    BufferLineErrorDiagnosticVisible = { bg = p.none },
    BufferLineErrorSelected = { bg = p.none, sp = p.none },
    BufferLineErrorVisible = { bg = p.none },
    BufferLineFill = { bg = p.none },
    BufferLineHint = { sp = p.none, bg = p.none },
    BufferLineHintDiagnostic = { sp = p.none, bg = p.none },
    BufferLineHintDiagnosticSelected = { bg = p.none, sp = p.none },
    BufferLineHintDiagnosticVisible = { bg = p.none },
    BufferLineHintSelected = { bg = p.none, sp = p.none },
    BufferLineHintVisible = { bg = p.none },
    BufferLineInfo = { sp = p.none, bg = p.none },
    BufferLineInfoDiagnostic = { sp = p.none, bg = p.none },
    BufferLineInfoDiagnosticSelected = { sp = p.none, bg = p.none },
    BufferLineInfoDiagnosticVisible = { bg = p.none },
    BufferLineInfoSelected = { bg = p.none, sp = p.none },
    BufferLineInfoVisible = { bg = p.none },
    BufferLineIndicatorSelected = { bg = p.none },
    BufferLineModified = { bg = p.none },
    BufferLineModifiedSelected = { bg = p.none },
    BufferLineModifiedVisible = { bg = p.none },
    BufferLineNumbers = { bg = p.none },
    BufferLineNumbersSelected = { bg = p.none },
    BufferLineNumbersVisible = { bg = p.none },
    BufferLineOffsetSeparator = { bg = p.none },
    BufferLineSeparator = { bg = p.none },
    BufferLineSeparatorSelected = { bg = p.none },
    BufferLineSeparatorVisible = { bg = p.none },
    BufferLineTab = { bg = p.none },
    BufferLinePick = { bg = p.none },
    BufferLinePickSelected = { bg = p.none },
    BufferLineDevIconLua = { bg = p.none },
    BufferLineDevIconLuaSelected = { bg = p.none },
    BufferLineDevIconLuaVisible = { bg = p.none },
    BufferLineDevIconLuaInactive = { bg = p.none },
    BufferLinePickVisible = { bg = p.none },
    BufferLineIndicatorVisible = { bg = p.none },
    BufferLineTabClose = { bg = p.none },
    BufferLineTabSelected = { bg = p.none },
    BufferLineTabSeparator = { bg = p.none },
    BufferLineTabSeparatorSelected = { bg = p.none },
    BufferLineTruncMarker = { bg = p.none },
    BufferLineWarning = { bg = p.none },
    BufferLineWarningDiagnostic = { bg = p.none },
    BufferLineWarningDiagnosticSelected = { bg = p.none },
    BufferLineWarningDiagnosticVisible = { bg = p.none },
    BufferLineWarningSelected = { bg = p.none },
    BufferLineWarningVisible = { bg = p.none },

    -- romgrk/barbar.nvim
    BufferCurrent = { fg = p.text, bg = p.none },
    BufferCurrentIndex = { fg = p.text, bg = p.none },
    BufferCurrentMod = { fg = p.teal1, bg = p.none },
    BufferCurrentSign = { fg = p.blueGray1, bg = p.none },
    BufferCurrentTarget = { fg = p.yellow, bg = p.none },
    BufferInactive = { fg = p.blueGray1, bg = p.none },
    BufferInactiveIndex = { fg = p.blueGray1, bg = p.none },
    BufferInactiveMod = { fg = p.teal1, bg = p.none },
    BufferInactiveSign = { fg = p.blueGray2, bg = p.none },
    BufferInactiveTarget = { fg = p.yellow, bg = p.none },
    BufferTabpageFill = { fg = groups.background, bg = groups.none },
    ...
    NvimTreeOpenedFile = { fg = p.text, bg = p.none },
    NvimTreeOpenedFolderName = { link = 'NvimTreeFolderName' },
    NvimTreeRootFolder = { fg = p.teal1 },
    NvimTreeSpecialFile = { link = 'NvimTreeNormal' },
    NvimTreeWindowPicker = { fg = groups.bg, bg = p.none },

    WinSeparator = { fg = (config.disable_background and p.blueGray3) or p.background3, bg = p.none },
    ...
    TelescopeSelection = { fg = p.text, bg = p.blueGray4 },
    ...
    TitleString = { bg = p.none, fg = p.blue2 },
    TitleIcon = { bg = p.none, fg = p.blue2 },
    SagaBorder = { bg = p.none, fg = p.background1 },
    SagaNormal = { bg = p.none },
    SagaExpand = { bg = p.none, fg = p.teal2 },
    ...
    -- Winbar
    WinBar = { fg = p.text, bg = p.none },
    WinBarNC = { fg = p.blueGray2, bg = p.none },
  }
